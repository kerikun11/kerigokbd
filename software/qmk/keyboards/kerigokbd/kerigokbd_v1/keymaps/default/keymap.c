...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [KGL_AM] = LAYOUT_split_6_7_7_4( /* Auto Mouse Layer (PointingDevice only) */
    KC_TAB , XXXXXXX, MS_BTN1, MS_BTN3, MS_BTN2, XXXXXXX,          /**/          XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_BSPC,
    KC_LCTL, XXXXXXX, XXXXXXX, KG_SCRL, XXXXXXX, XXXXXXX, XXXXXXX, /**/ XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KG_SCRL, XXXXXXX, KC_ENT ,
    KC_LSFT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, MS_BTN3, /**/ XXXXXXX, XXXXXXX, XXXXXXX, MS_BTN1, MS_BTN3, MS_BTN2, KC_DEL ,
                               KC_LWIN, KC_LALT, MS_BTN1, MS_BTN2, /**/ XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
  ),
};
#endif
// clang-format on
