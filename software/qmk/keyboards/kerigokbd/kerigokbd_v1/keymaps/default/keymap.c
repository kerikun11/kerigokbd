...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [KGL_AM] = LAYOUT_split_6_7_7_4( /* Auto Mouse Layer (PointingDevice only) */
    KC_TAB , XXXXXXX, MS_BTN1, MS_BTN3, MS_BTN2, XXXXXXX,          /**/          XXXXXXX, MS_BTN1, MS_BTN3, MS_BTN2, XXXXXXX, KC_BSPC,
    KC_LCTL, XXXXXXX, XXXXXXX, KG_SCRL, XXXXXXX, XXXXXXX, MS_BTN3, /**/ MS_BTN3, XXXXXXX, XXXXXXX, KG_SCRL, XXXXXXX, XXXXXXX, KC_ENT ,
    KC_LSFT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, MS_BTN2, /**/ MS_BTN2, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_DEL ,
